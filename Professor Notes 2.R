...
Data = read.table("https://faculty.mccombs.utexas.edu/carlos.carvalho/teaching/RunsPerGame.txt",header=T)
attach(Data)
...
Tele = read.table("https://faculty.mccombs.utexas.edu/carlos.carvalho/teaching/Tele.txt",header=T)
attach(Tele)
...
model4 = lm(LogP~T+as.matrix(X)+ LogPlag)
